    ...
    xiG = {
      ...
      items: xi.map((j) => ({
        ...
        extra: esTemp
          ...
          : <span><b className="num">{j.goles ?? 0}</b> {(j.goles ?? 0) === 1 ? 'gol' : 'goles'}</span>,
      })),
      leyenda: <><b>Pos</b> posición en el campo · once ideal de toda la categoría, calculado con normalización entre grupos.</>,
    }
  }
