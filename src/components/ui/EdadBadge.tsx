...
// del sistema (--zona-po). Excluyente; `null` no pinta nada. El texto (no el color) es lo que distingue el
// tramo. Es un hecho de categoría por temporada, nunca una fecha. Ver src/lib/badgeEdad.ts.
