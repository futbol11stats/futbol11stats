...
import { ORDEN_JUVENILES as COMPETICION_ORDER } from '@/lib/competiciones'
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="space-y-3">
        {ordenadas.map(comp => (
          <CompeticionCard key={comp} nombre={comp} grupos={map[comp]} categoria="juveniles" nombreHistorico={historicoMap[comp]} />
        ))}
        {grupos.length === 0 && (
