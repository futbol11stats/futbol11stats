  ...
  return (
    <div className="bg-pitch-800 rounded-xl border border-pitch-700 overflow-hidden hover:border-grass-500/50 transition-colors">
      ...
      <div className="px-4 py-2 flex flex-wrap gap-2">
        {grupos.length > 1 && (
          <Link
            href={`/madrid/juveniles/${grupos[0].slug_comp}/global/2025-26/jornada-${grupos[0].jornada_actual}/top5-jugadores-jornada`}
        ...
        {grupos.map(g => (
          <Link
            key={g.codgrupo}
            href={`/madrid/juveniles/${g.slug_comp}/${g.slug_grupo}/2025-26/jornada-${g.jornada_actual}/clasificacion`}
